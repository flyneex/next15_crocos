        ...
        <div className='bg-[#FAFCFD] pt-[60px] pb-[40px]'>
            <div className='max-w-[1720px] m-auto flex justify-between items-center gap-[176px]'>
                <div className='flex-[0_0_calc(60%_-_176px)]'>
                    <div className='flex mb-[70px] gap-[120px]'>
                        <div>
                            <Image src='/_2172106763472.png' alt='Logo' width={175} height={58}/>
                        </div>
                        <div className='flex gap-5'>
                            <div className='flex items-center gap-7'>
                                <Image src='/Emblem_of_Astana_(latin).png' alt='Logo' width={57} height={57}/>
                                <p className='max-w-[167px]'>Управление жилья и жилищной инспекции города Астаны</p>
                            </div>
                            <div className='flex items-center gap-7'>
                                <Image src='/Emblem_of_Astana_(latin).png' alt='Logo' width={57} height={57}/>
                                <p>Акимат города <br/>Астаны</p>
                            </div>
                        </div>
                    </div>
                    <div className='flex gap-[145px] mb-[58px]'>
                        ...
                        <div className='flex gap-2.5'>
                            ...
                            <div>
                                <ul>
                                    <li className='mb-2.5'>График приема документов: Пн-Пт 08:30-17:00</li>
                    ...
                    <div className='flex gap-2.5'>
                        ...
                        <div
                            className="bg-[#0B84EE] rounded-[50%] w-[32px] h-[32px] pt-[6px] pl-[11px] pr-[11px] pb-[7px]">
                            <Image
                                src="/facebook.svg"
                                alt='Facebook'
                                width={10}
